...
try:
    ...
    try:
        catalog_collection = client.get_collection('course_catalog', embedding_function=sentence_transformer_ef)
    ...
    try:
        content_collection = client.get_collection('course_content', embedding_function=sentence_transformer_ef)
